...
const StarIcon: React.FC<StarIconProps> = ({ className,height="24",width="24",fill="#FFD700"}) => {
  return (
    <svg
      width={width}
      height={height}
      ...
      className={`w-6 h-6 ${className}`} // Default Tailwind styles, customizable via props
    >
      <path
        ...
        fill={fill} // Allows the icon to inherit text color
      />
    </svg>
  );
};
